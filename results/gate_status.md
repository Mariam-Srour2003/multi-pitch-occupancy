...
| ✔ | Every quantitative claim re-derives | 34 claims re-derive from their artefacts |
...
| | criterion | evidence |
|---|---|---|
| ✔ | Claims ledger complete and verified | 34 claims re-derive from their artefacts |
