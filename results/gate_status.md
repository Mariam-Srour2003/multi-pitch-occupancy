...
| ✔ | Every quantitative claim re-derives | 28 claims re-derive from their artefacts |
...
| | criterion | evidence |
|---|---|---|
| ✔ | Claims ledger complete and verified | 28 claims re-derive from their artefacts |
