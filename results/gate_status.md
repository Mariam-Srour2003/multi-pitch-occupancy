...
| ✔ | Every quantitative claim re-derives | 39 claims re-derive from their artefacts |
...
| | criterion | evidence |
|---|---|---|
| ✔ | Claims ledger complete and verified | 39 claims re-derive from their artefacts |
