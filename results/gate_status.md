...
| ✔ | Every quantitative claim re-derives | 45 claims re-derive from their artefacts |
...
| | criterion | evidence |
|---|---|---|
| ✔ | Claims ledger complete and verified | 45 claims re-derive from their artefacts |
