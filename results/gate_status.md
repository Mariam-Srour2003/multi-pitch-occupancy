...
| ✔ | Every quantitative claim re-derives | 47 claims re-derive from their artefacts |
...
| | criterion | evidence |
|---|---|---|
| ✔ | Claims ledger complete and verified | 47 claims re-derive from their artefacts |
