...
The work was built on a chain of 61 stacked feature branches, each on top of the last, and
...
main  <- everything is here
  └── history: setup/project-scaffold → feat/dataset-manifest → ... → 61 branches, each stacked on the last
```
