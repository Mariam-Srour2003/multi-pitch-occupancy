...
25 experiment scripts, 32 test files. Clone it and everything is
...
The work was built on a chain of 57 stacked feature branches, each on top of the last, and
...
main  <- everything is here
  └── history: setup/project-scaffold → feat/dataset-manifest → ... → 57 branches, each stacked on the last
```
