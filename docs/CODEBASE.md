...
25 experiment scripts, 33 test files. Clone it and everything is
...
The work was built on a chain of 65 stacked feature branches, each on top of the last, and
...
main  <- everything is here
  └── history: setup/project-scaffold → feat/dataset-manifest → ... → 65 branches, each stacked on the last
```
