...
The work was built on a chain of 69 stacked feature branches, each on top of the last, and
...
main  <- everything is here
  └── history: setup/project-scaffold → feat/dataset-manifest → ... → 69 branches, each stacked on the last
```
