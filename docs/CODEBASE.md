...
18 experiment scripts, 28 test files. Clone it and everything is
...
The work was built on a chain of 40 stacked feature branches, each on top of the last, and
...
main  <- everything is here
  └── history: setup/project-scaffold → feat/dataset-manifest → ... → 40 branches, each stacked on the last
```
