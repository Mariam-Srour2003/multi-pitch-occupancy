...
<!-- branch-report:start -->
`main` carries the whole project — 57 commits, 45 source
...
The work was built on a chain of 34 stacked feature branches, each on top of the last, and
...
main  <- everything is here
  └── history: setup/project-scaffold → feat/dataset-manifest → ... → 34 branches, each stacked on the last
```
