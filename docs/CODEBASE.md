...
<!-- branch-report:start -->
`main` carries the whole project — 60 commits, 46 source
...
The work was built on a chain of 36 stacked feature branches, each on top of the last, and
...
main  <- everything is here
  └── history: setup/project-scaffold → feat/dataset-manifest → ... → 36 branches, each stacked on the last
```
